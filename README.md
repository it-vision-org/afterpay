...
A personal monthly salary and expense tracker. AfterPay starts from your
monthly salary and subtracts your recurring commitments and one-time
expenses within your current salary period — the rolling month that starts
on the day you're actually paid, not the 1st of the calendar month — so you
always know exactly how much you have left.
...
```
backend/    Spring Boot REST API (com.afterpay)
mobile/     Flutter app
...
```bash
java -Djava.net.preferIPv4Stack=true -jar build/libs/afterpay-api-*.jar
```
